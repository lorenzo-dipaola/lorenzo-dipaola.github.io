---
title: "Le dinamiche digitali della rifunzionalizzazione"
permalink: /projects/rifunzionalizzazione/
author_profile: true
---
...
- presence is co-produced by bodies, devices, and environmental scripts.
...
## ◼︎ 2. Digital spaces as reconfigured environments

The project examined how digital platforms generate **new spatial logics** where:

- proximity becomes an effect of interaction rather than physical co-presence;  
- public and private spheres merge within hybrid communicative settings;  
...
## ◼︎ 3. The refunctionalization of cultural imaginaries

Digital platforms do not simply host cultural content: they **reshape it**.  
The project analysed how imaginaries related to identity, fandom, narrative consumption, and self-presentation are **reframed through platform logics**, including:

- algorithmic visibility;  
- curated forms of self-representation;  
- new participatory rituals;  
- hybrid genres that merge visual storytelling, data, and performance.

Rather than establishing new imaginaries, platforms tend to **redirect existing ones**, offering new functions and symbolic uses to already established cultural forms.

---

## ◼︎ 4. Sport, datafication, and the mediated body

Drawing on case studies on cycling platforms and digital sports communities, the project explored how digital systems:

- transform training into a data-driven narrative;  
- mediate athletic identity through metrics, rankings, and social comparison;  
- merge physical performance with symbolic storytelling;  
- create hybrid communities organised around shared digital practices.
...
The project also examined how the pandemic accelerated the **integration of digital technologies** into daily routines, consolidating:

- platform-mediated communication;  
- hybrid forms of teaching, working, and socialising;  
